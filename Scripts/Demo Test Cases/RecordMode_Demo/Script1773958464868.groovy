...
WebUI.click(findTestObject('Page_CURA Healthcare Service/td_7'))

WebUI.setText(findTestObject('Page_CURA Healthcare Service/textarea_Comment'), 'Comments here....')
...
WebUI.click(findTestObject('Page_CURA Healthcare Service/p_Facility'))

WebUI.rightClick(findTestObject('Page_CURA Healthcare Service/p_Facility'))

WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/p_Facility'), 'Tokyo CURA Healthcare Center')
